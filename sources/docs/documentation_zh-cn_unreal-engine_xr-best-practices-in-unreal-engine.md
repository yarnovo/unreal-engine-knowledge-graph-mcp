...
-   **比例（Scale）：** VR场景中的物体比例应尽可能地模拟真实情况。物体过大或过小可能会导致用户产生困惑，或者产生[晕眩](/documentation/zh-cn/unreal-engine/xr-best-practices-in-unreal-engine#vrandsimulationsickness)。
